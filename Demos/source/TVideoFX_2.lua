...
function TVideoFX_2:New()
	
	return class(self)
end


function TVideoFX_2:Initialize()
	...
	-- RETRO:ClipDebugEnable(COLOR_GREEN)
	-- RETRO:BatchDebugEnable(COLOR_WHITE, COLOR_BLACK)
end

function TVideoFX_2:Update(dt)
	
end

function TVideoFX_2:PreRender() 
end

function TVideoFX_2:Render()



		RETRO:ClipSet(RETRO:Rect2i(8, 8, 320-4-8-4, 200-24-8-4));
		
		RETRO:EffectSet(Effect.Scanlines,2)
        ...
        RETRO:EffectSet(Effect.Scanlines,0)
