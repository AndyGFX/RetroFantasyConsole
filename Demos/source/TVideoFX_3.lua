...
function TVideoFX_3:New()
	
	return class(self)
end


function TVideoFX_3:Initialize()
...
function TVideoFX_3:PreRender() 
end

function TVideoFX_3:Update(dt)
	
end

function TVideoFX_3:Render()



		RETRO:ClipSet(RETRO:Rect2i(8, 8, 320-4-8-4, 200-24-8-4));

		RETRO:EffectSet(Effect.Pixelate,0.1)
        ...
        RETRO:EffectSet(Effect.Pixelate,0)
